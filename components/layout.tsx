...
import seachSvg from '../public/img/search.svg'
import thumbsUpSvg from '../public/img/thumbs-up.svg'
import thumbsDownSvg from '../public/img/thumbs-down.svg'
import popeFrancis from '../public/img/pope-francis.png'
import people from '../public/img/bg-people.png'
                        ...
                        <div className="featured-card__content">
                            ...
                            <div className="featured-card__buttons">
                                <button className="icon-button" aria-label="thumbs up">
                                    <Image src={ thumbsUpSvg } width={ 30 } height={ 30 } alt="thumbs up" />
                                </button>
                                <button className="icon-button" aria-label="thumbs down">
                                    <Image src={ thumbsDownSvg } width={ 30 } height={ 30 } alt="thumbs down" />
                                </button>
                            </div>
                        </div>
                    </div>
